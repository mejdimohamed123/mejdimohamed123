   ...
   Utilisateur user;
    ...
    private void modifierutilisateur(ActionEvent event) throws IOException {
         ...
         if (nom.getText().equals(""))
            ...
            c.modifierutilisateur(new Utilisateur(user.getId(),nom.getText(), prenom.getText(), user.getPassword(), email.getText(),adresse.getText(),"user",d,username.getText(),user.getPhoto(),0,0));
